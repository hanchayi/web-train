...
![Paste_Image.png](https://img.smyhvae.com/20151001_19.jpg)

相对路径的面试题。现有如下文件层级图：

![](https://img.smyhvae.com/20170630_1133.png)
...
![Paste_Image.png](https://img.smyhvae.com/2015-10-01-cnblogs_html_21.png)
...
![Paste_Image.png](https://img.smyhvae.com/2015-10-01-cnblogs_html_20.png)
...
![](https://img.smyhvae.com/2015-10-02-cnblogs_html_19.png)

2、`align="center"`：图片和文字水平方向上居中对齐。显示效果：

![](https://img.smyhvae.com/2015-10-02-cnblogs_html_21.png)

3、`align="top"`：图片与文字顶端对齐。显示效果：

![](https://img.smyhvae.com/2015-10-02-cnblogs_html_22.png)

4、`align="left"`：图片在文字的左边。显示效果：

![](https://img.smyhvae.com/2015-10-02-cnblogs_html_23.png)

5、`align="right"`：图片在文字的右边。显示效果：

![](https://img.smyhvae.com/2015-10-02-cnblogs_html_24.png)
